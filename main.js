...
function uploadgreencar() {
	ctx.drawImage(greencar_imagTag, greencar_x, greencar_y, greencar_width, greencard_height);//Define function ‘uploadgreencar’.
...
function up()
{
	if(greencar_y >= 0)
	{
		...
		console.log("When up arrow is pressed, x = " + greencar_x + " | y = " +greencar_y);//Define function to move the car upward
		uploadBackground();
		uploadgreencar();
	}
}
...
function down()
{
	...
	{
		greencar_y = greencar_y + 10;
		console.log("When down arrow is pressed, x = " + greencar_x + " | y = " +greencar_y);//Define function to move the car upward
		uploadBackground();
		uploadgreencar();
